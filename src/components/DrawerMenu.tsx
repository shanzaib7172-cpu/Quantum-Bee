    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-border">
          <h2 className="text-lg font-semibold font-heading text-gradient">NexusAI</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="glass rounded-xl p-3 space-y-2.5">
              ...
              <Button
                size="sm"
                className="w-full h-8 text-xs bg-primary/15 text-primary border border-primary/20 hover:bg-primary/25 hover:border-primary/40 transition-all"
                variant="ghost"
              >
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              {agentCards.map((agent) => (
                ...
                >
                  <div className="absolute top-2 right-2 text-[10px] font-mono font-medium text-primary bg-primary/10 px-1.5 py-0.5 rounded-md">
                    {agent.price}
                  </div>
                  <agent.icon className="w-5 h-5 text-accent mb-2 group-hover:text-primary transition-colors" />
